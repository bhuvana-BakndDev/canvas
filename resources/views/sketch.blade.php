...
<html>
  ...
  background.src = "http://sketching.dv/test.jpg";
  ...
  background.onload = function() {
    ...
    function save() {
        ...
        //     imageObj1.src = $('.getimage').attr('src');
        //     imageObj1.onload = function() {
        //     ctx1.drawImage(imageObj1, 0, 0, 328, 526);
        //     imageObj2.src = dataURL;
        //     imageObj2.onload = function() {
        //         ctx1.drawImage(imageObj2, 15, 85, 300, 300);
                // var img = c1.toDataURL("image/png");
                document.write('<img src="' + dataURL + '" width="328" height="526"/>');
...
// });
    ...
    <!-- <img class="getimage" src="http://sketching.dv/images.jpeg"> -->
        <canvas id="can" width="1200" height="2000" style="position:absolute;top:10%;left:10%;border:2px solid;"></canvas>
