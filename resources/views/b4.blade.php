...
<html>
    ...
    <body onload="init()">
        <canvas id="can" width="1200" height="700"  style="position:absolute;top:10%;left:10%;border:2px solid; src='https://asia.olympus-imaging.com/content/000107507.jpg';"></canvas>
